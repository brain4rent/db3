...
curl -i -H "Content-type: application/json" -X GET http://bernhardt.sqrawler.com/api/users/splatts/1

#Task 5
#Gets the users followed by the first user
curl -i -H "Content-type: application/json" -X GET http://bernhardt.sqrawler.com/api/users/follows/1

#Task 6
#Displays the first user's newsfeed
curl -i -H "Content-type: application/json" -X GET http://bernhardt.sqrawler.com/api/users/splatts-feed/1

#Task 7
#Causes the first user to unfollow the third user
curl -i -H "Content-type: application/json" -X DELETE http://bernhardt.sqrawler.com/api/users/follows/1/3
